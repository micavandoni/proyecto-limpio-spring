		              		...
		              		<div id="myGallery" class="carousel slide" data-interval="false">
								<div class="carousel-inner">
									<div class="item active">
										<img id="" src="img/portfolio/${propiedad.imagenUrl}" alt="item0">
										<div class="carousel-caption"></div>
									</div>
									<div class="item">
										<img id="" src="img/portfolio/${propiedad.imagenUrl2}" alt="item1">
										<div class="carousel-caption"></div>
									</div>
									<div class="item">
										<img id="" src="img/portfolio/${propiedad.imagenUrl3}" alt="item2">
										<div class="carousel-caption"></div>
									</div>
									<div class="item">
										<img id="" src="img/portfolio/${propiedad.imagenUrl4}" alt="item3">
										<div class="carousel-caption"></div>
									</div>
									<!--end carousel-inner-->
								</div>
